...
const unsigned short COLLISION_ATTR_ALLIESBULLETS = 0b1 << 2;
const unsigned short COLLISION_ATTR_ENEMIES = 0b1 << 3;
const unsigned short COLLISION_ATTR_ENEMIEBULLETS = 0b1 << 4;
