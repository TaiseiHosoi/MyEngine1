...
bool GamePad::ButtonTrigger(GamePadButton button)
{
	//トリガー
	if (button == LT)
	{
...
bool GamePad::StickTrigger(GamePadStick stickInput, const float& deadRange, const Vector2& deadRate)
{
	Vector2 oldVec;
	Vector2 vec;
...
bool GamePad::ButtonInput(GamePadButton button)
{
	if (button == LT)
	{
...
bool GamePad::StickInput(GamePadStick stickInput, const float& deadRange, const Vector2& deadRate)
{
	Vector2 vec;
	bool isLeftStick = stickInput <= L_RIGHT;
...
bool GamePad::LeftStickInput(const float& deadRange) {
...
bool GamePad::ButtonOffTrigger(GamePadButton button)
{
	//トリガー
	if (button == LT)
	{
...
bool GamePad::StickOffTrigger(GamePadStick stickInput, const float& deadRange, const Vector2& deadRate)
{
	Vector2 oldVec;
	Vector2 vec;
	bool isLeftStick = stickInput <= L_RIGHT;
...
void GamePad::ShakeGamePad(const float& power, const int& span)
{
