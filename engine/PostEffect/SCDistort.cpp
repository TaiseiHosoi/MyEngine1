...
void SCDistort::CreatGraphicsPipelineState()
{
	HRESULT result;
	...
	result = D3DCompileFromFile(
		L"Resources/shaders/SCDistortVS.hlsl", //シェーダーファイル名
		nullptr,
	...
	result = D3DCompileFromFile(
		L"Resources/shaders/SCDistortPS.hlsl",
		nullptr,
...
void SCDistort::PreDrawScene(ID3D12GraphicsCommandList* cmdList)
{
...
void SCDistort::Draw(ID3D12GraphicsCommandList* cmdList)
{
